// This file contains the data for all the clues in the treasure hunt.
// You can easily edit the text for each clue here.
...
Out in the sun, eternally youthful friends, perhaps more, coz inside is a bore.`,
  ...
  },
  {
    ...
    text: `A habitat, a hirsute host, among, this village of masters old.
The denizen warm, eager, when others seemed cold.
An agreeable sort, friendly,  and easy, at least for PMIRs.
An un-resented presence, as a nectar gathering bee, less so maybe for Bummers.`,
    backgroundImage: "/thimage.jpg",
  },
  {
    id: 6,
